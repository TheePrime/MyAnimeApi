...
export declare class Logger {
     ...
     * ```
     */
    static info: ({ message, infoColor, messageColor, logs }: loggerParams) => void;
    /**
     *
     ...
     * ```
     */
    static warn: ({ message, infoColor, messageColor, logs }: loggerParams) => void;
    /**
     *
     ...
     * ```
     */
    static error: ({ message, infoColor, messageColor, logs }: loggerParams) => void;
}
/**
 *
 ...
 * ```
 */
export declare const Borgen: ({ methodColor, routeColor, statusColor, resTimeColor, statusCodesCl, logs }: BorgenParams) => (req: any, res: any, next: any) => void;
export {};
